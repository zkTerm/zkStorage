...
exports.shareFile = exports.deleteFile = exports.listFiles = exports.downloadFileContent = exports.uploadContent = exports.downloadShared = exports.downloadFileByCid = exports.downloadFile = exports.uploadFile = exports.defaultService = void 0;
...
function createStorageService(config) {
    const client = (0, client_1.createStorageClient)(config);
            ...
            if (file.size > maxFileSize) {
                return {
                    ...
                    error: {
                        ...
                        userMessage: `File size exceeds ${(0, crypto_1.formatFileSize)(maxFileSize)} limit. Current: ${(0, crypto_1.formatFileSize)(file.size)}`,
                    },
                };
            }
            onProgress?.(10);
            // Step 1: Encrypt file client-side
            const encryptedData = await (0, crypto_1.encryptFile)(file, password);
            onProgress?.(50);
     ...
     * @param onProgress - Optional progress callback (0-100)
     */
    async function uploadContent(content, metadata, password, onProgress) {
        try {
            ...
            if (content.byteLength > maxFileSize) {
                return {
                    ...
                    error: {
                        ...
                        userMessage: `Content size exceeds ${(0, crypto_1.formatFileSize)(maxFileSize)} limit. Current: ${(0, crypto_1.formatFileSize)(content.byteLength)}`,
                    },
                };
            }
            onProgress?.(10);
            // Encrypt content
            const encryptedData = await (0, crypto_1.encryptContent)(content, password, metadata);
            onProgress?.(50);
            // Upload
            const uploadResult = await client.uploadToStorage(encryptedData);
            onProgress?.(90);
    ...
    async function downloadFile(fileId, password) {
        ...
        try {
            ...
            const decryptedData = await (0, crypto_1.decryptFile)(downloadResult.encryptedContent, downloadResult.metadata, password);
            // Step 3: Trigger download
            (0, crypto_1.downloadDecryptedFile)(decryptedData);
            return {
                success: true,
     ...
     */
    async function downloadFileContent(fileId, password) {
        try {
            const downloadResult = await client.downloadFromStorage(fileId);
            if (!downloadResult.success || !downloadResult.encryptedContent || !downloadResult.metadata) {
                return {
     ...
     * @param password - User's password for decryption
     */
    async function downloadFileByCid(cid, metadataCid, password) {
        if (!(0, crypto_1.isBrowser)()) {
            return {
                success: false,
                error: {
     ...
     */
    async function shareFile(fileId, password, expiresInHours) {
        try {
            // Generate a unique share key
            const shareKey = await (0, crypto_1.generateShareKey)();
     ...
     */
    async function downloadShared(shareToken, shareKey) {
        if (!(0, crypto_1.isBrowser)()) {
            return {
                success: false,
                error: {
        ...
        try {
            ...
            const decryptedData = await (0, crypto_1.decryptFile)(result.encryptedContent, result.metadata, shareKey);
            (0, crypto_1.downloadDecryptedFile)(decryptedData);
            return {
                success: true,
                name: decryptedData.name,
    ...
    return {
        ...
        shareFile,
        // Re-export utilities
        formatFileSize: crypto_1.formatFileSize,
        getIPFSGatewayUrl: client.getIPFSGatewayUrl,
    };
}
// Export a default service for convenience
exports.defaultService = createStorageService();
// Re-export individual functions from default service
// Browser-only
exports.uploadFile = exports.defaultService.uploadFile, exports.downloadFile = exports.defaultService.downloadFile, exports.downloadFileByCid = exports.defaultService.downloadFileByCid, exports.downloadShared = exports.defaultService.downloadShared, 
// Universal
exports.uploadContent = exports.defaultService.uploadContent, exports.downloadFileContent = exports.defaultService.downloadFileContent, exports.listFiles = exports.defaultService.listFiles, exports.deleteFile = exports.defaultService.deleteFile, exports.shareFile = exports.defaultService.shareFile;
